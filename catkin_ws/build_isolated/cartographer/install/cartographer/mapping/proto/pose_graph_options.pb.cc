...
void TableStruct::InitDefaultsImpl() {
  ...
  ::cartographer::mapping::pose_graph::proto::protobuf_cartographer_2fmapping_2fpose_5fgraph_2fproto_2fconstraint_5fbuilder_5foptions_2eproto::InitDefaults();
  ::cartographer::mapping::pose_graph::proto::protobuf_cartographer_2fmapping_2fpose_5fgraph_2fproto_2foptimization_5fproblem_5foptions_2eproto::InitDefaults();
  _PoseGraphOptions_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_PoseGraphOptions_default_instance_);_PoseGraphOptions_default_instance_._instance.get_mutable()->constraint_builder_options_ = const_cast< ::cartographer::mapping::pose_graph::proto::ConstraintBuilderOptions*>(
      ::cartographer::mapping::pose_graph::proto::ConstraintBuilderOptions::internal_default_instance());
  _PoseGraphOptions_default_instance_._instance.get_mutable()->optimization_problem_options_ = const_cast< ::cartographer::mapping::pose_graph::proto::OptimizationProblemOptions*>(
      ::cartographer::mapping::pose_graph::proto::OptimizationProblemOptions::internal_default_instance());
}
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "o\032Fcartographer/mapping/pose_graph/proto"
      "/constraint_builder_options.proto\032Hcarto"
      "grapher/mapping/pose_graph/proto/optimiz"
      "ation_problem_options.proto\"\331\003\n\020PoseGrap"
      "hOptions\022\036\n\026optimize_every_n_nodes\030\001 \001(\005"
      "\022c\n\032constraint_builder_options\030\003 \001(\0132\?.c"
      "artographer.mapping.pose_graph.proto.Con"
      "straintBuilderOptions\022\"\n\032matcher_transla"
      "tion_weight\030\007 \001(\001\022\037\n\027matcher_rotation_we"
      "ight\030\010 \001(\001\022g\n\034optimization_problem_optio"
      "ns\030\004 \001(\0132A.cartographer.mapping.pose_gra"
      "ph.proto.OptimizationProblemOptions\022 \n\030m"
      "ax_num_final_iterations\030\006 \001(\005\022\035\n\025global_"
      "sampling_ratio\030\005 \001(\001\022\037\n\027log_residual_his"
      "tograms\030\t \001(\010\0220\n(global_constraint_searc"
      "h_after_n_seconds\030\n \001(\001b\006proto3"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 711);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "cartographer/mapping/proto/pose_graph_options.proto", &protobuf_RegisterTypes);
  ::cartographer::mapping::pose_graph::proto::protobuf_cartographer_2fmapping_2fpose_5fgraph_2fproto_2fconstraint_5fbuilder_5foptions_2eproto::AddDescriptors();
  ::cartographer::mapping::pose_graph::proto::protobuf_cartographer_2fmapping_2fpose_5fgraph_2fproto_2foptimization_5fproblem_5foptions_2eproto::AddDescriptors();
}
} // anonymous namespace
...
PoseGraphOptions::PoseGraphOptions(const PoseGraphOptions& from)
  ...
  if (from.has_constraint_builder_options()) {
    constraint_builder_options_ = new ::cartographer::mapping::pose_graph::proto::ConstraintBuilderOptions(*from.constraint_builder_options_);
  } else {
    constraint_builder_options_ = NULL;
  }
  if (from.has_optimization_problem_options()) {
    optimization_problem_options_ = new ::cartographer::mapping::pose_graph::proto::OptimizationProblemOptions(*from.optimization_problem_options_);
  } else {
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // .cartographer.mapping.pose_graph.proto.ConstraintBuilderOptions constraint_builder_options = 3;
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
      ...
      // .cartographer.mapping.pose_graph.proto.OptimizationProblemOptions optimization_problem_options = 4;
      case 4: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
...
// @@protoc_insertion_point(class_specific_merge_from_start:cartographer.mapping.proto.PoseGraphOptions)
  ...
  if (from.has_constraint_builder_options()) {
    mutable_constraint_builder_options()->::cartographer::mapping::pose_graph::proto::ConstraintBuilderOptions::MergeFrom(from.constraint_builder_options());
  }
  if (from.has_optimization_problem_options()) {
    mutable_optimization_problem_options()->::cartographer::mapping::pose_graph::proto::OptimizationProblemOptions::MergeFrom(from.optimization_problem_options());
  }
...
const ::cartographer::mapping::pose_graph::proto::ConstraintBuilderOptions& PoseGraphOptions::constraint_builder_options() const {
  const ::cartographer::mapping::pose_graph::proto::ConstraintBuilderOptions* p = constraint_builder_options_;
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.PoseGraphOptions.constraint_builder_options)
  return p != NULL ? *p : *reinterpret_cast<const ::cartographer::mapping::pose_graph::proto::ConstraintBuilderOptions*>(
      &::cartographer::mapping::pose_graph::proto::_ConstraintBuilderOptions_default_instance_);
}
::cartographer::mapping::pose_graph::proto::ConstraintBuilderOptions* PoseGraphOptions::mutable_constraint_builder_options() {
  
  if (constraint_builder_options_ == NULL) {
    constraint_builder_options_ = new ::cartographer::mapping::pose_graph::proto::ConstraintBuilderOptions;
  }
...
::cartographer::mapping::pose_graph::proto::ConstraintBuilderOptions* PoseGraphOptions::release_constraint_builder_options() {
  // @@protoc_insertion_point(field_release:cartographer.mapping.proto.PoseGraphOptions.constraint_builder_options)
  
  ::cartographer::mapping::pose_graph::proto::ConstraintBuilderOptions* temp = constraint_builder_options_;
  constraint_builder_options_ = NULL;
  return temp;
}
void PoseGraphOptions::set_allocated_constraint_builder_options(::cartographer::mapping::pose_graph::proto::ConstraintBuilderOptions* constraint_builder_options) {
  delete constraint_builder_options_;
...
const ::cartographer::mapping::pose_graph::proto::OptimizationProblemOptions& PoseGraphOptions::optimization_problem_options() const {
  const ::cartographer::mapping::pose_graph::proto::OptimizationProblemOptions* p = optimization_problem_options_;
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.PoseGraphOptions.optimization_problem_options)
  return p != NULL ? *p : *reinterpret_cast<const ::cartographer::mapping::pose_graph::proto::OptimizationProblemOptions*>(
      &::cartographer::mapping::pose_graph::proto::_OptimizationProblemOptions_default_instance_);
}
::cartographer::mapping::pose_graph::proto::OptimizationProblemOptions* PoseGraphOptions::mutable_optimization_problem_options() {
  
  if (optimization_problem_options_ == NULL) {
    optimization_problem_options_ = new ::cartographer::mapping::pose_graph::proto::OptimizationProblemOptions;
  }
...
::cartographer::mapping::pose_graph::proto::OptimizationProblemOptions* PoseGraphOptions::release_optimization_problem_options() {
  // @@protoc_insertion_point(field_release:cartographer.mapping.proto.PoseGraphOptions.optimization_problem_options)
  
  ::cartographer::mapping::pose_graph::proto::OptimizationProblemOptions* temp = optimization_problem_options_;
  optimization_problem_options_ = NULL;
  return temp;
}
void PoseGraphOptions::set_allocated_optimization_problem_options(::cartographer::mapping::pose_graph::proto::OptimizationProblemOptions* optimization_problem_options) {
  delete optimization_problem_options_;
